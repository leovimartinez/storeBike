...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { codigo_producto: @producto.codigo_producto, descripcion: @producto.descripcion, modelo: @producto.modelo, nombre: @producto.nombre, precio: @producto.precio }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { codigo_producto: @producto.codigo_producto, descripcion: @producto.descripcion, modelo: @producto.modelo, nombre: @producto.nombre, precio: @producto.precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
